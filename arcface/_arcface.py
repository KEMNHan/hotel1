...
class Gender(Enum):#性别
    Female = 0
    Male = 1
class Angle3D(metaclass=ShowMetaclass):#人脸的角度信息
...
class FaceInfo(metaclass=ShowMetaclass):#保存单张人脸信息
    ...
    def to_sdk_face_info(self):
        ...
        return face_info
class ArcFace:#ArcSoft Face 的封装
...
def main():
    ArcFace.APP_ID = b"CaCM22E2aTM4TfFixyLpdxsf8LfirekKqGVftfN7Nn13"
    ArcFace.SDK_KEY = b"D4KQkj26GaVdzTbkqavTh2pgjieFZAWJfMBp16nmw2jE"
    arcface = ArcFace(ArcFace.IMAGE_MODE)
    image = cv.imread(r"001.jpg")
    # cv.waitKey(1000)
